...
ENV CANTALOUPE_UID=501 \
    ...
    ENDPOINT_PUBLIC_AUTH_BASIC_USERNAME="kinexis" \
    ...
    FILESYSTEMSOURCE_BASICLOOKUPSTRATEGY_PATH_PREFIX="/var/local/cantaloupe/images/" \
    ...
    LOG_APPLICATION_FILEAPPENDER_PATHNAME="/var/local/cantaloupe/logs/application.log" \
    LOG_APPLICATION_ROLLINGFILEAPPENDER_ENABLED="false" \
    LOG_APPLICATION_ROLLINGFILEAPPENDER_PATHNAME="/var/local/cantaloupe/logs/application.log" \
    LOG_APPLICATION_ROLLINGFILEAPPENDER_POLICY="TimeBasedRollingPolicy" \
    LOG_APPLICATION_ROLLINGFILEAPPENDER_TIMEBASEDROLLINGPOLICY_FILENAME_PATTERN="/var/local/cantaloupe/logs/application-%d{yyyy-MM-dd}.log" \
    ...
    LOG_ERROR_FILEAPPENDER_PATHNAME="/var/local/cantaloupe/logs/error.log" \
    LOG_ERROR_ROLLINGFILEAPPENDER_ENABLED="false" \
    LOG_ERROR_ROLLINGFILEAPPENDER_PATHNAME="/var/local/cantaloupe/logs/error.log" \
    LOG_ERROR_ROLLINGFILEAPPENDER_POLICY="TimeBasedRollingPolicy" \
    LOG_ERROR_ROLLINGFILEAPPENDER_TIMEBASEDROLLINGPOLICY_FILENAME_PATTERN="/var/local/cantaloupe/logs/error-%d{yyyy-MM-dd}.log" \
    ...
    LOG_ACCESS_FILEAPPENDER_PATHNAME="/var/local/cantaloupe/logs/access.log" \
    LOG_ACCESS_ROLLINGFILEAPPENDER_ENABLED="false" \
    LOG_ACCESS_ROLLINGFILEAPPENDER_PATHNAME="/var/local/cantaloupe/logs/access.log" \
    LOG_ACCESS_ROLLINGFILEAPPENDER_POLICY="TimeBasedRollingPolicy" \
    LOG_ACCESS_ROLLINGFILEAPPENDER_TIMEBASEDROLLINGPOLICY_FILENAME_PATTERN="/var/local/cantaloupe/logs/access-%d{yyyy-MM-dd}.log" \
